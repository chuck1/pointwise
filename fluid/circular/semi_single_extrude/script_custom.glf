...
set _TMP(mode_1) [pw::Application begin Create]
  ...
  $_TMP(PW_1) addPoint $pt_out
  $_TMP(PW_1) addPoint $pt_in
...
set _TMP(mode_3) [pw::Application begin Modify [list $_CN(1)]]
  ...
  $_TMP(PW_4) setBeginSpacing $delta_in
  unset _TMP(PW_4)
$_TMP(mode_3) end
unset _TMP(mode_3)
...
set _TMP(mode_4) [pw::Application begin Modify [list $_CN(1)]]
  ...
  $_TMP(PW_5) setEndSpacing $delta_out
  unset _TMP(PW_5)
$_TMP(mode_4) end
unset _TMP(mode_4)
pw::Application markUndoLevel {Change Spacing(s)}
...
$_TMP(PW_10) do setDimension $dim_core
$_TMP(PW_10) delete
unset _TMP(PW_10)
pw::Application markUndoLevel {Dimension}
